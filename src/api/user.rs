use crate::utils::acquire::{
    BaseKey, CodeMaoClient, HttpMethod, MewError, MewResult, PaginatedIter,
};
...
impl UserDataFetcher {
    ...
    /// 获取用户详细信息
    pub async fn fetch_user_profile(&self, user_id: i32) -> MewResult<Value> {
    ...
    /// 获取用户 Tiger 信息
    pub async fn fetch_user_tiger(&self, user_id: i32) -> MewResult<Value> {
    ...
    /// 获取用户 info 信息
    pub async fn fetch_user_info(&self, user_id: i32) -> MewResult<Value> {
    ...
    /// 获取用户荣誉信息
    pub async fn fetch_user_honors(&self, user_id: i32) -> MewResult<Value> {
        self.client
            .build_request(
                HttpMethod::GET,
    ...
    /// 获取用户业务数据指标
    pub async fn fetch_user_metrics(&self, user_id: i32) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户基本信息
    pub async fn fetch_user_intro(&self, user_id: i32) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户动态信息
    pub async fn fetch_user_dynamic(&self, user_id: i32) -> MewResult<Value> {
    ...
    /// 获取用户加入的工作室信息
    pub async fn fetch_user_studio(&self, user_id: i32) -> MewResult<Value> {
    ...
    /// 获取用户年度总结
    pub async fn fetch_user_annual_summary(&self, user_id: i32) -> MewResult<Value> {
        self.client
    ...
    /// 获取账户信息 (简略)
    pub async fn get_account_info(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取当前账号详细信息
    pub async fn fetch_account_details(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取平台账号资料
    pub async fn fetch_account_platform_profile(&self, method: PlatformMethod) -> MewResult<Value> {
    ...
    /// 获取账号隐私设置
    pub async fn fetch_account_privacy(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取 Tiger 账号信息
    pub async fn fetch_account_tiger(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户评分数据
    pub async fn fetch_account_scores(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户等级信息
    pub async fn fetch_account_level(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户动态信息
    pub async fn fetch_account_dynamic(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户作品
    pub async fn fetch_account_works(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户注册时间
    pub async fn fetch_account_register_time(&self) -> MewResult<Value> {
        self.client
    ...
    /// 获取课程账号信息
    pub async fn fetch_account_lesson_info(&self) -> MewResult<Value> {
        self.client
    ...
    /// 搜索用户作品 (Nemo 端)
    pub async fn search_user_works_nemo(
        &self,
        query: &str,
    ...
    /// 获取用户云端作品
    pub async fn fetch_cloud_works(
        &self,
        types: CloudWorkType,
        limit: Option<i32>,
        offset: Option<i32>,
    ...
    /// 获取用户证书信息
    pub async fn fetch_user_certificate(&self, user_id: i32) -> MewResult<Value> {
        self.client
            .build_request(
                HttpMethod::GET,
    ...
    pub fn fetch_coco_works_gen(
        ...
        paginated.with_limit(limit.unwrap_or(30))
    }

    /// 获取用户所有Coco作品
    pub async fn fetch_coco_all_works(&self, limit: Option<i32>) -> MewResult<Value> {
        self.client
            .build_request(
                HttpMethod::GET,
    ...
    /// 获取用户已发布作品
    pub async fn fetch_published_works(
        &self,
        user_id: i32,
        types: Vec<WorkType>,
        limit: Option<i32>,
    ...
    /// 获取用户关注列表
    pub async fn fetch_user_attention(&self, user_id: i32) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户粉丝列表
    pub async fn fetch_user_followers(&self, user_id: i32) -> MewResult<Value> {
        self.client
    ...
    /// 获取用户头像框列表
    pub async fn fetch_avatar_frames(&self) -> MewResult<Value> {
        self.client
            .build_request(
                HttpMethod::GET,
    ...
    /// 检查用户是否为新用户
    pub async fn check_new_user_status(&self) -> MewResult<Value> {
        self.client
            .build_request(
                HttpMethod::GET,
...
impl UserManager {
    ...
    /// 验证手机号码
    pub async fn validate_phone_number(&self, phone_num: i32) -> MewResult<Value> {
        self.client
            .build_request(
                HttpMethod::GET,
    ...
    /// 修改密码
    pub async fn update_password(&self, old_password: &str, new_password: &str) -> MewResult<bool> {
        let response = self
            .client
    ...
    /// 请求更换手机号验证码
    pub async fn execute_request_phone_change_verification(
        &self,
        old_phonenum: i32,
        new_phonenum: i32,
    ) -> MewResult<bool> {
    ...
    /// 更新手机号码
    pub async fn update_phone_number(&self, captcha: i32, phonenum: i32) -> MewResult<Value> {
        self.client
            .build_request(
                HttpMethod::PATCH,
    ...
    /// 移除头像框
    pub async fn delete_avatar_frame(&self) -> MewResult<bool> {
        let response = self
            .client
            .build_request(
                HttpMethod::PUT,
    ...
    /// 应用头像框
    pub async fn execute_apply_avatar_frame(&self, frame_id: AvatarFrameId) -> MewResult<bool> {
    ...
    /// 更新个人主页封面
    pub async fn update_profile_cover(&self, cover_url: &str) -> MewResult<bool> {
        let response = self
            .client
            .build_request(HttpMethod::POST, "/nemo/v2/user/preview", None)
            .with_payload(json!({ "preview": cover_url }))
            .send()
            .await?;
    ...
    /// 注销用户
    pub async fn delete_user(&self, reason: &str, return_data: bool) -> MewResult<Value> {
        let response = self
            .client
            .build_request(HttpMethod::POST, "/tiger/v3/web/accounts/close", None)
            .with_payload(json!({ "closeReason": reason }))
            .send()
            .await?;
